...
const sazenListings: ListingSeed[] = [
  ...
  // Horii Shichimeien
  { name: 'Narino', brandName: 'Horii Shichimeien', url: 'https://www.sazentea.com/en/products/p330-matcha-narino.html', imageUrl: 'https://horiishichimeien.com/cdn/shop/products/MG_8628_1080x.jpg', description: 'Premium matcha from Horii Shichimeen with rich, satisfying flavor.' },
  { name: 'Mumon', brandName: 'Horii Shichimeien', url: 'https://www.sazentea.com/en/products/p331-matcha-mumon.html', imageUrl: 'https://horiishichimeien.com/cdn/shop/products/MG_8633_1080x.jpg', description: 'Gateless matcha with direct, unpretentious character and honest flavor.' },
  { name: 'Agata No Shiro', brandName: 'Horii Shichimeien', url: 'https://www.sazentea.com/en/products/p336-matcha-agata-no-shiro.html', imageUrl: 'https://horiishichimeien.com/cdn/shop/files/IMG_9794-2_1080x.jpg', description: 'White of the estate matcha with elegant, refined taste and beautiful color.' },
  { name: 'Uji Mukashi', brandName: 'Horii Shichimeien', url: 'https://www.sazentea.com/en/products/p337-matcha-uji-mukashi.html', imageUrl: 'https://horiishichimeien.com/cdn/shop/files/IMG_9821-2_1080x.jpg', description: 'Ancient Uji matcha with traditional, time-honored flavor profile.' },
...
const nakamuraListings: ListingSeed[] = [
  ...
  { name: 'Matcha Fuji-no-Shiro Can 30g', brandName: 'Nakamura Tokichi', url: 'https://global.tokichi.jp/products/mc2', variantId: '44231891747068', imageUrl: 'https://global.tokichi.jp/cdn/shop/files/01_b3f3099f-86e4-4280-a557-96807276f70f.jpg', description: 'Wisteria white matcha in traditional can. Elegant flavor with smooth texture and sweet aftertaste.' },
  { name: 'Matcha Hatsu-Mukashi 30g Can', brandName: 'Nakamura Tokichi', url: 'https://global.tokichi.jp/products/mc12', variantId: '44231891714300', imageUrl: 'https://global.tokichi.jp/cdn/shop/files/01_85900642-2179-473a-b6fb-2e9f7a892808.jpg', description: 'First ancient matcha with traditional, time-honored flavor. Rich umami with sweet aftertaste.' },
